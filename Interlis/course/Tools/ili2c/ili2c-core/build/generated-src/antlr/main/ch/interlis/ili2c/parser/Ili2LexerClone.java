...
public class Ili2LexerClone extends antlr.CharScanner implements Ili1UndefTokenTypes, TokenStream
 {

  public boolean isIli1=false;
public Ili2LexerClone(InputStream in) {
	this(new ByteBuffer(in));
}
public Ili2LexerClone(Reader in) {
	this(new CharBuffer(in));
}
public Ili2LexerClone(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public Ili2LexerClone(LexerSharedInputState state) {
	super(state);
	caseSensitiveLiterals = true;
	setCaseSensitive(true);
	literals = new Hashtable();
	literals.put(new ANTLRHashString("undefiniert", this), new Integer(4));
	literals.put(new ANTLRHashString("LNBASE", this), new Integer(12));
	literals.put(new ANTLRHashString("PI", this), new Integer(11));
	literals.put(new ANTLRHashString("Zeichen", this), new Integer(7));
	literals.put(new ANTLRHashString("letztes", this), new Integer(6));
}
...
tryAgain:
	...
	public final void mILI_DOC(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			...
			else if ((_tokenSet_3.member(LA(1))) && ((LA(2) >= '\u0000' && LA(2) <= '\ufffe')) && ((LA(3) >= '\u0000' && LA(3) <= '\ufffe')) && (true) && (true)) {
				{
				match(_tokenSet_3);
				}
			}
	...
	public final void mML_COMMENT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		_loop1789:
		do {
			if ((LA(1)=='/') && (LA(2)=='*') && (_tokenSet_0.member(LA(3))) && ((LA(4) >= '\u0000' && LA(4) <= '\ufffe')) && ((LA(5) >= '\u0000' && LA(5) <= '\ufffe'))) {
				mML_COMMENT(false);
			}
			else if ((LA(1)=='\r') && (LA(2)=='\n') && ((LA(3) >= '\u0000' && LA(3) <= '\ufffe')) && ((LA(4) >= '\u0000' && LA(4) <= '\ufffe')) && (true)) {
				match('\r');
	...
	protected final void mPOSINT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			if (((LA(1) >= '0' && LA(1) <= '9'))) {
				...
				if ( _cnt1836>=1 ) { break _loop1836; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
			}
	...
	protected final void mDEC(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		if (((_tokenSet_1.member(LA(1))) && (_tokenSet_6.member(LA(2))) && (_tokenSet_6.member(LA(3))) && (_tokenSet_7.member(LA(4))) && (_tokenSet_8.member(LA(5))))) {
			int _m1852 = mark();
				...
				case '0':
				{
					...
					do {
						if ((LA(1)=='0')) {
							...
							if ( _cnt1850>=1 ) { break _loop1850; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
						}
	...
	public final void mHEXNUMBER(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			if ((_tokenSet_9.member(LA(1)))) {
				...
				if ( _cnt1858>=1 ) { break _loop1858; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
			}
...
inputState.guessing--;
			...
			if ( synPredMatched1863 ) {
				...
				boolean synPredMatched1867 = false;
				if (((_tokenSet_1.member(LA(1))) && (true) && (true) && (true) && (true))) {
					int _m1867 = mark();
					synPredMatched1867 = true;
					inputState.guessing++;
					try {
						{
						mNUMBER(false);
						...
						synPredMatched1867 = false;
					}
					rewind(_m1867);
inputState.guessing--;
				}
				if ( synPredMatched1867 ) {
					{
					if (((_tokenSet_1.member(LA(1))) && (true) && (true) && (true) && (true))&&(isIli1)) {
						mILI1_DEC(false);
						if ( inputState.guessing==0 ) {
							_ttype = ILI1_DEC;
						}
					}
					else if (((_tokenSet_1.member(LA(1))) && (true) && (true) && (true) && (true))&&(!isIli1)) {
						mDEC(false);
						if ( inputState.guessing==0 ) {
							_ttype = DEC;
						}
